      ...
      <div class="col-md-13">
        <div class="col-md-6">
          <div class="embed-responsive embed-responsive-16by9">
            <iframe width="560" height="315" style="padding-right: 20px;" align="left" src="http://www.youtube.com/embed/{{$curso->video}}?theme=light&showinfo=0" frameborder="0"></iframe>
          </div>
        </div>
          <section aling="right">
            ...
            <li class="divider"></li>
            <br>
            <p style="font-family: 'Noto Sans', sans-serif;"><a href="{{route('auth.profiles', $curso->user->id)}}" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Tutor del curso"><img src="{{asset('avatars/'.$curso->user->image)}}" style="width: 54px;height: 54px;border-radius: 50%;margin-right: 10px;">{!!$curso->user->name!!} </a></p>
          </section>
      </div>
      </article>
  </div>
  ...
  <div class="col-md-6">
    <div class="card radius shadowDepth1">
      <div class="card__image border-tlr-radius">
        <img src="{{asset('images/'.$articulo->image)}}" alt="image" class="border-tlr-radius">
      </div>
      ...
      <article class="card__article">
        ...
        <p>{!!substr(strip_tags($articulo->body), 0, 355)!!}{!!strlen(strip_tags($articulo->body)) > 355 ? '...' : ""!!}</p>
      </article>
    </div>
    ...
    <div class="card__action">
      ...
      <div class="card__author">
          <div class="card__author-content">
            <p style="font-family: 'Noto Sans', sans-serif;color: #33b5e5;"><img src="{{asset('avatars/'.$articulo->user->image)}}" style="width: 54px;height: 54px;border-radius: 50%;margin-right: 10px;"><a href="{{route('auth.profiles', $articulo->user->id)}}">{!!$articulo->user->name!!} </a> </p>
          </div>
        </div>
      </div>
    </div>
