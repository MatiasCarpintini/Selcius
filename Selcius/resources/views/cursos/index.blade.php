  ...
  @foreach($cursos as $curso)
      <div class="col-md-6">
        <div class="card">
          ...
          <span class="card-title activator grey-text text-darken-4"><p><a href="{{route('cursos.show', $curso->id)}}"><p style="font-family: 'Varela Round', sans-serif;font-size: 40px;"><img src="{{asset('images/'.$curso->icono)}}" class="circle"> {!!$curso->title!!}
              @if($curso->level == 1)
